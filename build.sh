...
sudo docker --authfile=/etc/containers/auth.json push iad.ocir.io/pritunl8472/pritunl-bastion:"$date"
sudo docker --authfile=/etc/containers/auth.json push iad.ocir.io/pritunl8472/pritunl-bastion:latest
echo $date
